...
public class FPSMouseLook : MonoBehaviour
{
    ...
    void HandleRotation()
    {
        ...
        if (axes == RotationAxes.MouseX)
        {
            ...
            Quaternion xQuarternion = Quaternion.AngleAxis(rotation_X, Vector3.up);
        ...
        if (axes == RotationAxes.MouseY)
        {
            ...
            Quaternion yQauternion = Quaternion.AngleAxis(-rotation_Y, Vector3.right);

            transform.localRotation = originalRotation * yQauternion;
        }
    }
